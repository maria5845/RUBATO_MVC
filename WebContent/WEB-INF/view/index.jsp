		...
		<section id="main">
			...
			<section id="notice_free_youtube">
				...
				<article id="free">
					...
					<div class="latest_content">
						<img class="image" src="img/book_pen.gif">
						<c:forEach items="${mainList}" var="m_list" end="3">
							<ul class="list">
								<li>
								<div class="subject"><a href="board_view_page.do?b_no=${m_list.b_no }">${m_list.b_title }</a></div>
								<div class="date">${m_list.b_writedate }</div>
								<div class="clear"></div>
							</li>
							</ul>
						</c:forEach>
